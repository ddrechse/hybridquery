...
CREATE TABLE papers_nodes (
    ...
    content_embedding VECTOR(768, FLOAT32) -- Nomic-embed-text uses 768 dimensions
) TABLESPACE users_assm;
...
CREATE TABLE treatments_nodes (
    ...
    description_embedding VECTOR(768, FLOAT32) -- Embedding of "TreatmentName + Description"
) TABLESPACE users_assm;
...
CREATE TABLE conditions_nodes (
    ...
    description_embedding VECTOR(768, FLOAT32) -- Used for semantic matching (e.g. Graph Trap)
) TABLESPACE users_assm;
...
-- VECTOR INDEXES (IVF for performance)
